...
The course is the same under all course numbers, except for the PhD-level 17-745 number, which replaces two homework assignments with a mandatory [research project](https://github.com/mlip-cmu/f2025/blob/main/assignments/research_project.md).
...
Labs Friday 9:30-10:50am in Wean 4709 (B) and 11-12:20pm in PH A22 (C) and GHC 4102 (D) and 2-3:20 in PH 226C (E) and PH A21 (F). 

Instructors: [Christian Kaestner](https://www.cs.cmu.edu/~ckaestne/) and [Bogdan Vasilescu](https://bvasiles.github.io)

TAs: Kaushik Koirala, Krishnaprasad Vijayshankar, Michelle Wang, Bhuvana Murugadoss, and Nikita Chaudhari
...
**Participation:** Design and engineering content requires active engagement with the material and discussions of judgment decisions on specific scenarios and cases. We strongly believe in in-class discussions and in-class exercises and want all students to participate, e.g., answering or asking questions in class, sharing own experiences, presenting results, or participating in in-class votes and surveys. We will give many opportunities for participation in every lecture and lab. We note student engagement with in-class activities to include as a component in grading. We also consider cheating in in-class activities as an academic integrity violation (see below).  We will provide feedback at mid-semester so that you can check in on how you’re doing. Again, please talk to us if you need accommodations.
